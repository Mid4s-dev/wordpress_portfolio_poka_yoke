...
<section id="projects" class="py-16 bg-white relative">
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div class="project-card bg-white rounded-lg overflow-hidden shadow-lg transition-transform hover:shadow-xl hover:-translate-y-2">
                <div class="h-48 bg-shuka-red flex items-center justify-center relative overflow-hidden">
                    <div class="absolute top-0 left-0 w-full h-full bg-shuka-pattern from-shuka-red to-shuka-black opacity-20"></div>
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-700 mb-4">Completed Kioptrix series, Brainpan lab, 30+ TryHackMe rooms, BSides Nairobi & university hackathons.</p>
                    <div class="mt-4">
                        <span class="text-sm font-medium block mb-2 text-shuka-black">Skills applied:</span>
            ...
            <div class="project-card bg-white rounded-lg overflow-hidden shadow-lg transition-transform hover:shadow-xl hover:-translate-y-2">
                <div class="h-48 bg-shuka-blue flex items-center justify-center relative overflow-hidden">
                    <div class="absolute top-0 left-0 w-full h-full bg-shuka-pattern from-shuka-blue to-shuka-black opacity-20"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 text-white relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-700 mb-4">Built applications using Laravel, Django, React, and WordPress with secure authentication systems and RESTful APIs.</p>
                    <div class="mt-4">
                        <span class="text-sm font-medium block mb-2 text-shuka-black">Technologies used:</span>
                        <div class="flex flex-wrap gap-2">
            ...
            <div class="project-card bg-white rounded-lg overflow-hidden shadow-lg transition-transform hover:shadow-xl hover:-translate-y-2">
                <div class="h-48 bg-shuka-earth flex items-center justify-center relative overflow-hidden">
                    <div class="absolute top-0 left-0 w-full h-full bg-shuka-pattern from-shuka-earth to-shuka-black opacity-20"></div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 text-white relative z-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-700 mb-4">Installed secure Wi-Fi, firewalls, VPNs, CCTV; provided cybersecurity training and OS hardening.</p>
                    <div class="mt-4">
                        <span class="text-sm font-medium block mb-2 text-shuka-black">Services provided:</span>
                        <div class="flex flex-wrap gap-2">
