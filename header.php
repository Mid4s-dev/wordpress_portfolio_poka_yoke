        ...
        <div class="container mx-auto flex items-center justify-between px-4 py-4 sm:px-6">
            ...
            <nav id="site-navigation" class="main-navigation">
                ...
                <div class="hidden md:flex md:items-center md:gap-4">
                    ...
                    <a href="#testimonials" class="nav-link text-white hover:text-shuka-yellow font-medium py-2 px-3 rounded-md transition-all hover:bg-shuka-red/60"><?php esc_html_e( 'Testimonials', 'portfolio' ); ?></a>
                            ...
                            <div class="flex-1 flex flex-col justify-center px-6 overflow-y-auto bg-shuka-pattern-large from-shuka-black to-shuka-earth/30 bg-opacity-5">
                                <div class="space-y-1">
                                    ...
                                    <a href="#testimonials" class="mobile-nav-link font-medium text-white hover:text-shuka-yellow transition-colors py-4 border-b border-shuka-red/30 hover:border-shuka-yellow -mx-6 px-6 flex items-center">
                                        <div class="mr-4 p-2 bg-shuka-black rounded-full border border-shuka-yellow">
