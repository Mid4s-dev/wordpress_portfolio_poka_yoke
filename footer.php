    ...
    <section class="relative py-16 bg-shuka-black text-white">
    ...
    <footer id="colophon" class="relative py-16 bg-shuka-black text-white site-footer">
        <div class="absolute inset-0 opacity-20 from-maroon to-shuka-black bg-shuka-pattern-large"></div>
        
        <div class="relative z-10 container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-6 pb-2 text-shuka-yellow border-b border-maroon/30 footer-heading">
                ...
                <div>
                    ...
                    <div class="flex flex-col space-y-3 footer-links">
                        <a href="#about" class="flex items-center gap-2 text-white/80 hover:text-shuka-yellow transition-colors">
                ...
                <div>
                    <h3 class="text-xl font-bold mb-6 pb-2 text-shuka-yellow border-b border-shuka-red/30 footer-heading">
                        <?php esc_html_e( 'Services', 'portfolio' ); ?>
                    </h3>
                    <div class="flex flex-col space-y-3 footer-links">
                        <a href="#" class="flex items-center gap-2 text-white/80 hover:text-shuka-yellow transition-colors">
                ...
                <div>
                    ...
                    <div class="flex gap-3 mb-6 footer-social">
                        <a href="https://github.com/Mid4s-dev" target="_blank" rel="noopener noreferrer" aria-label="GitHub" 
                           class="p-3 rounded-full text-shuka-red bg-shuka-red/20 border border-shuka-red/30
                        ...
                        <a href="https://linkedin.com/in/joshua-lugaya-mid4s-dev" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" 
                           class="p-3 rounded-full text-shuka-blue bg-shuka-blue/20 border border-shuka-blue/30 
                        ...
                        <a href="https://twitter.com/mid4s_dev" target="_blank" rel="noopener noreferrer" aria-label="Twitter" 
                           class="p-3 rounded-full text-shuka-yellow bg-shuka-yellow/20 border border-shuka-yellow/30 
                    ...
                    <address class="not-italic text-white/80">
                        <div class="flex items-start gap-3 mb-3">
                            <div class="p-2 mt-1 rounded-full text-shuka-red bg-shuka-red/20 border border-shuka-red/30">
                        ...
                        <div class="flex items-start gap-3">
                            <div class="p-2 mt-1 rounded-full text-shuka-blue bg-shuka-blue/20 border border-shuka-blue/30">
            ...
            <div class="mt-12 pt-6 text-center border-t border-shuka-yellow/20 footer-bottom">
